...
def train(hyp):
    ...
    # ADMM
    if opt.admm:
        admm = admm_op(model, ema=ema, b=opt.bits, admm_iter=opt.admm_iter)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if opt.admm:
            ...
            # apply quant for testing and saving
            admm.applyquantW()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/uav_last.pt', help='initial weights path')
    parser.add_argument('--name', default='admm_qw', help='renames results.txt to results_name.txt if supplied')
    ...
    parser.add_argument('--admm-iter', type=int, default=10, help='gap length of admm iter (epoch)')
